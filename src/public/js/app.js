...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _like__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./like */ "./resources/js/like.js");
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            itemId = e.target.id; // /posts/{postId}/likeにPOSTリクエストを送信
            _context.n = 1;
            return fetch("/item/".concat(itemId, "/like"), {
              method: "POST",
              // リクエストメソッドはPOST
              headers: {
